// =====================================================
// Weather Graph App - 100% Eclipse IDE Compatible
// No arrow functions, no class properties, ES5 syntax
// =====================================================
...
WeatherApp.prototype.displayWeatherGraph = function(weatherData) {
 ...
 labels: labels,
 datasets: [{
 label: 'Temperature C - ' + (weatherData.city ? weatherData.city.name 
: 'Unknown'),
 data: temperatures,
